            ...
            <div className="mt-6 space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Interaktive Kalorienrechner, Tracking-Tools und Werkzeuge für deine MATADOR-Zyklen. (Wert: 20€)</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-2xl flex-shrink-0">📄</span>
                <div>
                  ...
                  <p className="text-gray-700">Einkaufslisten, Meal-Prep-Pläne, Phasen-Tracker für Diätpausen und mehr. (Wert: 15€)</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-2xl flex-shrink-0">📱</span>
                <div>
                  ...
                  <p className="text-gray-700">Die besten Apps zum Tracking deiner Zyklen und Fortschritte. (Wert: 5€)</p>
                </div>
              </div>
            </div>
