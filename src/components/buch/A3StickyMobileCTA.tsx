...
/**
 * Mobile-only sticky bottom CTA for /dfgk34k-3.
 * Activates only after the user scrolls past the first price box (#preis-box-1).
 */
const A3StickyMobileCTA = () => {
      ...
      >
        <div className="flex flex-col items-start leading-tight">
          ...
          <span className="text-sm font-semibold">
            <span className="line-through opacity-60 mr-1.5 font-normal">34,99&nbsp;€</span>
            9,99&nbsp;€ sichern
          </span>
        </div>
...
export default A3StickyMobileCTA;
