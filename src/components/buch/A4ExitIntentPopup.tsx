...
const STORAGE_KEY = "exitIntentShown_dfgk34k-4";

const A4ExitIntentPopup = () => {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-w-md sm:max-w-lg p-0 overflow-hidden">
        ...
        <div className="px-6 py-6">
          <div className="flex gap-4 items-center mb-5">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-muted-foreground leading-snug">
                100+ Seiten. Über 60 wissenschaftliche Quellen. Geschrieben für deinen gestressten Stoffwechsel.
              </p>
            </div>
          </div>
          ...
          <div className="text-center mb-4">
            ...
            <div className="flex items-center justify-center gap-3">
              <span className="text-base text-muted-foreground/50 line-through">
                {PRICING.anchorPrice}&nbsp;{PRICING.currency}
              </span>
          ...
          <div className="text-center mb-4"><CountdownTimer variant="compact" className="text-base" /></div>
          ...
          >
            ...
            >
              Ja – jetzt für {PRICING.price}&nbsp;{PRICING.currency} sichern
...
export default A4ExitIntentPopup;
