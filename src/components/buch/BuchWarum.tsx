      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground text-center mb-6">
            Warum so viele Menschen sich immer mehr anstrengen — und genau deshalb nicht vorankommen
          </h2>
          ...
          <div className="text-base md:text-lg text-foreground/80 space-y-3 leading-relaxed">
            ...
            <p>
              <strong className="text-foreground">Aber wenn Dein Körper bereits auf Stress, Unterversorgung oder wiederholte Diäten reagiert, wird genau diese Strategie selbst zum Problem.</strong>
            </p>
            <p>Dann wird Fortschritt nicht leichter, sondern schwerer.</p>
            <p>Der Hunger steigt. Die Energie sinkt. Die Geduld wird dünner. Und der Frust wächst, obwohl Du Dir eigentlich noch mehr Mühe gibst.</p>
            <p>An diesem Punkt glauben viele, sie müssten einfach noch disziplinierter werden.</p>
            <p><strong className="text-foreground">In Wahrheit liegt das Problem oft nicht bei Deiner Disziplin.</strong></p>
            <p className="font-semibold text-primary text-lg md:text-xl">
              In Wahrheit reagiert Dein Körper längst auf Schutz.
            </p>
