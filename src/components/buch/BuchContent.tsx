...
const handleBuyClick = (buttonLabel: string) => {
  trackButtonClick("/buch", buttonLabel, DIGISTORE_URL);
};
            ...
            <div className="hidden md:flex flex-row items-start gap-8">
              ...
              <div className="flex-1 space-y-2.5">
                ...
                <div className="bg-card border-2 border-primary/30 rounded-xl p-5 text-center shadow-xl relative overflow-hidden">
                  ...
                  <p className="text-sm text-muted-foreground font-medium tracking-wide mb-1">Aktuell noch zum Einf&uuml;hrungspreis erh&auml;ltlich</p>
                  <div className="flex items-baseline justify-center gap-2 mb-2">
                    <span className="text-base text-muted-foreground/50 line-through">34,99&nbsp;&euro;</span>
                    <span className="text-4xl font-extrabold text-foreground">29,99&nbsp;&euro;</span>
                  </div>
            ...
            <div className="md:hidden">
              ...
              <div className="space-y-1.5">
                ...
                <div className="bg-card border-2 border-primary/30 rounded-xl p-3 text-center shadow-xl relative overflow-hidden">
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-primary/60 via-primary to-primary/60" />
                  <p className="text-xs text-muted-foreground font-medium tracking-wide mb-1">Aktuell noch zum Einf&uuml;hrungspreis erh&auml;ltlich</p>
                  <div className="flex items-baseline justify-center gap-2 mb-2">
                    <span className="text-sm text-muted-foreground/50 line-through">34,99&nbsp;&euro;</span>
                    <span className="text-3xl font-extrabold text-foreground">29,99&nbsp;&euro;</span>
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="text-sm md:text-base text-foreground/80 leading-relaxed space-y-1 mb-3 md:mb-5">
              <p>Dein Körper zeigt Dir nicht, dass Du undiszipliniert bist.</p>
              <p>Er zeigt Dir, wie er aktuell reagiert.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-lg mx-auto">
            <div className="bg-card border-2 border-primary/30 rounded-2xl p-6 md:p-8 text-center shadow-xl relative overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-primary/60 via-primary to-primary/60" />
              <p className="text-sm text-muted-foreground font-medium tracking-wide mb-2 mt-1">
              ...
              <div className="flex items-baseline justify-center gap-3 mb-2">
                ...
                <span className="text-4xl md:text-5xl font-extrabold text-foreground">29,99&nbsp;&euro;</span>
              </div>
