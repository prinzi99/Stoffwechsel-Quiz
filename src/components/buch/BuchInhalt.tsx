...
const features = [
  { icon: TrendingDown, text: "warum wiederholte Diäten den Stoffwechsel immer unberechenbarer machen können" },
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground text-center mb-4">
            Was Du nach diesem Buch sehr wahrscheinlich zum ersten Mal klarer sehen wirst
          </h2>

          <p className="text-base md:text-lg text-foreground/80 text-center leading-relaxed mb-10">
            Keine Durchhalteparolen.<br />
            Keine Fitness-Phrasen.<br />
