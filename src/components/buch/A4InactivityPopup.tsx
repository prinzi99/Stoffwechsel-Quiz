...
const STORAGE_KEY = "inactivityPopupShown_dfgk34k-4";
const INACTIVITY_MS = 20_000;

const A4InactivityPopup = () => {
      ...
      <DialogContent className="max-w-sm rounded-2xl">
        ...
        <div className="text-center">
          <div className="flex items-baseline justify-center gap-2 mb-1">
            <span className="text-base text-muted-foreground/60 line-through">{PRICING.anchorPrice}&nbsp;{PRICING.currency}</span>
            <span className="text-3xl font-extrabold text-secondary">{PRICING.price}&nbsp;{PRICING.currency}</span>
          </div>
          ...
          <div className="mb-3"><CountdownTimer variant="compact" className="text-base" /></div>
          ...
          >
            Jetzt für {PRICING.price}&nbsp;{PRICING.currency} sichern
...
export default A4InactivityPopup;
