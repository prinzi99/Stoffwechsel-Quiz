          ...
          <div className="text-center lg:text-left min-w-0">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-[2.65rem] font-bold text-foreground leading-tight mb-3">
              ...
              <span className="text-primary">
                Du versuchst nur, ein biologisches Problem mit Disziplin zu lösen.
              </span>
            </h1>

            <p className="text-sm sm:text-base lg:text-lg text-muted-foreground mb-4 leading-relaxed">
              Wenn Dein Stoffwechsel trotz Disziplin, gesunder Ernährung und Bewegung nicht reagiert, liegt das oft nicht an fehlendem Willen. Sondern daran, dass Dein Körper längst auf Stress, Mangel oder alte Diätmuster antwortet.
            </p>

            <div className="text-sm sm:text-base text-foreground/80 space-y-1 mb-4 leading-relaxed text-left">
              <p>Du gibst Dir Mühe. Du willst es richtig machen.</p>
              <p><strong className="text-foreground">Und trotzdem passiert zu wenig.</strong></p>
              <p>Die Waage stagniert. Die Energie sinkt. Der Frust wächst.</p>
              <p>Nicht unbedingt, weil Du zu wenig tust. Sondern weil Dein Körper längst auf eine andere Logik reagiert als die, mit der Du versuchst, ihn zu steuern.</p>
              <p className="font-semibold text-foreground pt-1">Genau darum geht es in diesem Buch:</p>
              <p>Du verstehst, warum Dein Stoffwechsel blockiert — und was sich ändern muss, damit Fortschritt wieder möglich wird.</p>
            </div>
            ...
            <div className="space-y-1.5 mb-4 text-left">
              {[
                ...
                "was Dein Körper braucht, bevor er wieder loslässt",
              ].map((item, i) => (
            ...
            <div className="bg-primary/5 rounded-xl p-4 sm:p-5 border border-primary/20">
              ...
              <Button
                ...
                size="xl"
                asChild
                className="w-full h-auto min-h-[3rem] whitespace-normal leading-snug text-xs sm:text-sm md:text-base py-4 px-3 mb-1.5 shadow-xl"
              >
