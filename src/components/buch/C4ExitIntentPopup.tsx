...
const STORAGE_KEY = "exitIntentShown_x7q9p2-4";

const C4ExitIntentPopup = () => {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-w-md sm:max-w-lg p-0 overflow-hidden">
        ...
        <div className="px-6 py-6">
          <div className="flex gap-4 items-center mb-5">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-muted-foreground leading-snug">
                100+ Seiten. Über 60 wissenschaftliche Quellen. Geschrieben für deinen überangepassten Stoffwechsel.
              </p>
            </div>
          </div>
          ...
          <div className="text-center mb-4"><C4CountdownTimer variant="compact" className="text-base" /></div>
          ...
          >
            <a
              href="https://www.digistore24.com/product/693556?voucher=quizrabatt"
              target="_blank"
...
export default C4ExitIntentPopup;
