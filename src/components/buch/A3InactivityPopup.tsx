 ...
 * without scroll/touch interaction. Counterpart to desktop ExitIntent.
 */
const A3InactivityPopup = () => {
      ...
      <DialogContent className="max-w-sm rounded-2xl">
        ...
        <div className="text-center">
          <div className="flex items-baseline justify-center gap-2 mb-1">
            <span className="text-base text-muted-foreground/60 line-through">34,99&nbsp;€</span>
            <span className="text-3xl font-extrabold text-secondary">9,99&nbsp;€</span>
          </div>
...
export default A3InactivityPopup;
