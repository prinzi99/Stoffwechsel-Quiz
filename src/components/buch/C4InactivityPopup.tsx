...
const STORAGE_KEY = "inactivityPopupShown_x7q9p2-4";
const INACTIVITY_MS = 20_000;

const C4InactivityPopup = () => {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-w-sm rounded-2xl">
        ...
        <div className="text-center">
          ...
          <div className="mb-3"><C4CountdownTimer variant="compact" className="text-base" /></div>
...
export default C4InactivityPopup;
