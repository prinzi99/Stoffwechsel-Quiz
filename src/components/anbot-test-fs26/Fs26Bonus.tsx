    ...
    <section className="py-12 md:py-16 bg-card">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-10 bg-primary/5 border-2 border-accent rounded-xl p-6 md:p-8">
            <div className="inline-block bg-accent text-accent-foreground text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-4">
              🌱 Frühlings Special
            </div>
            ...
            <div className="border-t border-border pt-4 mb-4">
              ...
              <p className="text-2xl md:text-3xl font-bold text-primary mb-1">
                Dein Frühlingspreis: 9,99&nbsp;€
              </p>
              <p className="text-sm text-muted-foreground">
                Nur für kurze Zeit – Frühlings Special
              </p>
            </div>
            <a
              href={DIGISTORE_URL}
            ...
            >
              Jetzt für 9,99&nbsp;€ statt <span className="line-through ml-1">34,99&nbsp;€</span> sichern
            </a>
          </div>
        </div>
      </div>
