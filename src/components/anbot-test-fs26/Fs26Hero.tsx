    ...
    <section className="bg-[image:var(--hero-gradient)] py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <span className="inline-flex items-center gap-2 bg-accent text-accent-foreground font-bold text-sm md:text-base px-5 py-2 rounded-full mb-6 shadow-lg uppercase tracking-wider">
            <Sparkles className="w-4 h-4" />
            Frühlings Special – nur kurze Zeit
          </span>
          ...
          <span className="inline-block bg-white text-primary font-semibold text-base px-6 py-2 rounded-full mb-10 shadow-md">
            🌱 Frühlings-Aktion: 71% Rabatt – nur 9,99&nbsp;€
          </span>
