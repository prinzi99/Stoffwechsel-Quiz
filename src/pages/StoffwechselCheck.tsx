...
const StoffwechselCheck = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Stoffwechsel-Reset Check | Philipp's Biohack</title>
        <meta
          name="description"
          content="Finde heraus, ob dein Stoffwechsel aktuell unter Stress, Anpassung oder Stabilität läuft – mit dem kostenlosen Selbstcheck."
        />
...
export default StoffwechselCheck;
