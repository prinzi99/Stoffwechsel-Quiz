        ...
        <div className="max-w-2xl mx-auto">
          ...
          <section className="mb-12">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Gerade wenn Dein Körper sich an wiederholte Diäten angepasst hat
            </p>

            <h3 className="text-lg font-semibold text-foreground mb-4">
              Für Menschen mit einem angepassten Stoffwechsel
            </h3>

            <div className="space-y-4 text-muted-foreground leading-relaxed mb-8">
              <p>
                Gerade wenn Dein Körper durch wiederholte Diäten gelernt hat, mit immer weniger auszukommen, 
                können typische Strategien wie eine neue Diät oder noch mehr Verzicht das Problem sogar verstärken.
              </p>
              <p>
              ...
              <p className="mt-4">
                Der Leitfaden richtet sich speziell an Menschen, deren Stoffwechsel durch wiederholte Diäten und zu strenge Einschränkungen blockiert ist.
              </p>
            </div>
            ...
            <p className="text-xs text-muted-foreground/70 text-center mb-4">
              Viele Teilnehmer mit einem angepassten Stoffwechsel nutzen an dieser Stelle den Leitfaden, um ihren Stoffwechsel wieder in Bewegung zu bringen.
            </p>
            ...
            <div className="bg-card border border-border rounded-2xl p-6 md:p-8 shadow-md">
              <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <ul className="space-y-1.5">
                    {[
                      'mehr Spielraum bei der Ernährung',
                      'weniger Frust trotz Kontrolle',
