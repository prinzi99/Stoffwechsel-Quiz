...
const BuchBonusIntern = () => {
  return (
    <>
      <Helmet>
        <title>Bonusbereich | Philipp's Biohack</title>
        <meta
          name="description"
          content="Der interne Bonusbereich zum Buch – Tools, Rechner und Ressourcen für Leser."
        />
...
export default BuchBonusIntern;
