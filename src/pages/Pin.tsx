          ...
          <>
            ...
            <section className="bg-background px-5 py-12 md:py-16">
              <div className="max-w-2xl mx-auto">
                <h2 className="text-xl md:text-2xl font-bold text-foreground mb-10 md:mb-14">
                ...
                <div className="space-y-12 md:space-y-14">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <p className="text-base text-foreground leading-relaxed">
                        Wenn du über Wochen weniger isst, als dein Körper braucht, passiert etwas, das die wenigsten auf dem Schirm haben: Er fährt runter. Nicht weil er defekt ist. Sondern weil er denkt, es ist eine Hungersnot.
                      </p>
                      <p className="text-base text-foreground leading-relaxed">
                        Dein Grundumsatz sinkt. Deine Schilddrüse drosselt. Dein Körper verbrennt weniger – obwohl du weniger isst.
                      </p>
                      <p className="text-base text-foreground leading-relaxed">
                        Studien zeigen: Bei chronischem Kaloriendefizit kann der Energieverbrauch um bis zu 40 Prozent einbrechen.
                      </p>
                      <p className="text-base text-foreground leading-relaxed">
                        Das bedeutet: Die Diät, die vor drei Jahren funktioniert hat, funktioniert heute nicht mehr. Nicht weil du versagt hast. Sondern weil dein Körper dazugelernt hat.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <p className="text-base text-foreground leading-relaxed">
                        Du kannst perfekt Kalorien zählen und trotzdem nicht abnehmen. Weil Kalorien nur ein Teil der Geschichte sind.
                      </p>
                      <p className="text-base text-foreground leading-relaxed">
                        Insulin bestimmt, ob dein Körper Fett einlagert oder verbrennt. Wenn es dauerhaft erhöht ist – durch ständiges Snacken, Zucker, Stress – verbrennt dein Körper gar kein Fett. Gar keins.
                      </p>
                      <p className="text-base text-foreground leading-relaxed">
                        Cortisol, dein Stresshormon, entscheidet, wo Fett landet. Bei Dauerstress: am Bauch.
                      </p>
                      <p className="text-base text-foreground leading-relaxed">
                        Leptin sagt deinem Gehirn, wann du satt bist – aber wenn die Signale nicht mehr ankommen, hast du Hunger, obwohl deine Fettzellen voll sind.
                      </p>
                      <p className="text-base text-foreground leading-relaxed">
                        Und ab Mitte 35 sinkt Östrogen. Fett wandert von Hüfte und Oberschenkeln zum Bauch. Der Stoffwechsel wird langsamer. Heißhunger stärker. Das ist keine Einbildung – das ist Biochemie.
                      </p>
                      <p className="text-base text-foreground leading-relaxed">
                        Das Zusammenspiel dieser Hormone ist bei jedem Menschen anders. Deshalb funktioniert, was bei deiner Freundin klappt, bei dir vielleicht überhaupt nicht.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <p className="text-base text-foreground leading-relaxed">
                        ‚Iss weniger, beweg dich mehr' – das ignoriert alles, was du gerade gelesen hast.
                      </p>
                      <p className="text-base text-foreground leading-relaxed">
                        Dein Stoffwechsel ist kein Taschenrechner. Er reagiert auf Schlaf, Stress, Hormone, Vorgeschichte. Und er reagiert bei dir anders als bei jeder anderen Person.
                      </p>
                      <p className="text-base text-foreground leading-relaxed">
                        Bevor du die nächste Diät startest, lohnt sich eine Frage: Welches Muster steckt bei dir dahinter?
                      </p>
                    </div>
                    <div className="mt-6">
                      <button
